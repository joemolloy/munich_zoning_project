...
import pyGr.zoning_algorithm.octtree
import ConfigParser
import rasterio
...
if __name__ == "__main__":
    ...
    with rasterio.open(Config.get("Input", "combined_raster")) as r:
        ...
        region_octtree = pyGr.zoning_algorithm.octtree.OcttreeNode(envelope, None, None)
        ...
        if Config.getboolean("Parameters", "solve_iteratively"):
            ...
            region_octtree = pyGr.zoning_algorithm.octtree.build_out_nodes(Config, region_octtree, regions, raster_array, r.affine, pop_threshold)
